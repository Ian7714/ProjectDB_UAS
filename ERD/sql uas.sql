...
-- Schema dbuts__c
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `dbuts__c` ;
USE `dbuts__c` ;
...
CREATE TABLE IF NOT EXISTS `dbuts__c`.`Resep` (
  ...
  `langkah_memasak` TEXT NULL,
  `waktu_memasak` INT NULL,
  `jumlah_sajian` INT NULL,
  `tingkat_kesulitan` ENUM('mudah', 'sedang', 'sulit') NULL,
  `versi_resep` TEXT NULL,
...
CREATE TABLE IF NOT EXISTS `dbuts__c`.`Postingan` (
  ...
  `teks` TEXT NULL,
  `tanggal_pembuatan` DATETIME NULL,
  `jenis_postingan` ENUM('biasa', 'resep') NULL,
  `Pengguna_pengguna_id` INT NOT NULL,
  `Resep_resep_id` INT NULL,
...
CREATE TABLE IF NOT EXISTS `dbuts__c`.`Gambar` (
  ...
  `urutan` INT NULL,
  `Postingan_postingan_id` INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS `dbuts__c`.`Bahan` (
  ...
  `nama_bahan` VARCHAR(100) NULL,
  `satuan` VARCHAR(50) NULL,
  `kalori_per_unit` INT NULL,
...
CREATE TABLE IF NOT EXISTS `dbuts__c`.`Kolaborasi_Resep` (
  `peran` ENUM('pembuat', 'kontributor') NULL,
  `Resep_resep_id` INT NOT NULL,
  `Pengguna_pengguna_id` INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS `dbuts__c`.`Interaksi` (
  `interaksi_id` INT NOT NULL AUTO_INCREMENT,
  `tipe` ENUM('suka', 'simpan', 'bagikan', 'komentar') NULL,
  `tanggal_interaksi` DATETIME NULL,
  `teks_komentar` TEXT NULL,
  `Postingan_postingan_id` INT NOT NULL,
  `Pengguna_pengguna_id` INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS `dbuts__c`.`Pencarian` (
  `pencarian_id` INT NOT NULL AUTO_INCREMENT,
  `kata_kunci` VARCHAR(45) NULL,
  `tanggal_pencarian` DATETIME NULL,
  `Pengguna_pengguna_id` INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS `dbuts__c`.`Recook` (
  `recook_id` INT NOT NULL AUTO_INCREMENT,
  `tanggal_percobaan` DATE NULL,
  `hasil` ENUM('berhasil', 'gagal') NULL,
  `Pengguna_pengguna_id` INT NOT NULL,
  `status_baca` ENUM('sudah dibaca', 'belum') NULL,
  `Resep_resep_id` INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS `dbuts__c`.`Papan_Peringkat` (
  `peringkat_id` INT NOT NULL AUTO_INCREMENT,
  `periode` DATE NULL,
  `skor_pengaruh` INT NULL,
  `kategori` ENUM('paling disukai', 'paling berpengaruh', 'paling banyak direcook') NULL,
  `Pengguna_pengguna_id` INT NOT NULL,
  `Interaksi_interaksi_id` INT NOT NULL,
  `Interaksi_Postingan_postingan_id` INT NOT NULL,
  `Interaksi_Pengguna_pengguna_id` INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS `dbuts__c`.`Tantangan_Memasak` (
  `tantangan_id` INT NOT NULL AUTO_INCREMENT,
  `nama_tantangan` VARCHAR(45) NULL,
  `deskripsi` TEXT NULL,
  `tanggal_mulai` DATE NULL,
  `tanggal_selesai` DATE NULL,
  `hadiah` VARCHAR(45) NULL,
...
CREATE TABLE IF NOT EXISTS `dbuts__c`.`Peserta_Tantangan` (
  `Tantangan_Memasak_tantangan_id` INT NOT NULL,
  `tanggal_ikut` DATETIME NULL,
  `Pengguna_pengguna_id` INT NOT NULL,
  `Postingan_postingan_id` INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS `dbuts__c`.`Ulasan` (
  `ulasan_id` INT NOT NULL AUTO_INCREMENT,
  `isi_ulasan` TEXT NULL,
  `tanggal_ulasan` DATETIME NULL,
  `Resep_resep_id` INT NOT NULL,
  `Pengguna_pengguna_id` INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS `dbuts__c`.`Rencana_Menu` (
  `rencana_menu_id` INT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `dbuts__c`.`Detail_Rencana_Menu` (
  ...
  `catatan` TEXT NULL,
  `Rencana_Menu_rencana_menu_id` INT NOT NULL,
  `Resep_resep_id` INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS `dbuts__c`.`Rencana_Menu_Dibagikan` (
  `Rencana_Menu_rencana_menu_id` INT NOT NULL,
  `Pengguna_pengguna_id` INT NOT NULL,
  `tanggal_dibagikan` DATETIME DEFAULT CURRENT_TIMESTAMP,
