...
-- 1. Mengisi data Pengguna (usia > 17 tahun) dengan sandi angka diurutkan
INSERT INTO `Pengguna` (`email`, `nama_lengkap`, `nomor_telepon`, `tanggal_lahir`, `dibuat_pada`, `sandi`) VALUES
('fathan@email.com', 'Ahmad Fathan', '08123456789', '1995-05-20', NOW(), '1'),
('fernanda@email.com', 'Fernanda Rizky', '08571234567', '2000-10-15', NOW(), '2'),
('arsyad@email.com', 'Muhammad Arsyad', '08998765432', '1990-01-01', NOW(), '3'),
('raihan@email.com', 'Raihanu', '08112233445', '1988-12-12', NOW(), '4'),
('randy@email.com', 'Randibang', '08129988776', '2005-03-25', NOW(), '5'),
('thalia@email.com', 'Thaliaas', '08129988777', '2005-05-25', NOW(), '6');
...
INSERT INTO `Papan_Peringkat` (`periode`, `skor_pengaruh`, `kategori`, `Pengguna_pengguna_id`, `Interaksi_interaksi_id`, `Interaksi_Postingan_postingan_id`, `Interaksi_Pengguna_pengguna_id`) VALUES
('2026-05-01', 150, 'paling berpengaruh', 4, 3, 1, 4), 
